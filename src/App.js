...
import AOS from 'aos';
import pixelGirlGif from './assets/ab4xqv.gif';
...
const Portfolio = () => {
  ...
  const skills = {
    ...
    frameworks: [
      'ASP.NET MVC', 'ASP.NET Web API', 'Entity Framework Core', 'Flask',
      'Angular', 'React', 'Flutter', 'jQuery', 'Bootstrap', 'Node.js',
      'Express.js', 'Tailwind CSS'
    ],
    tools: [
      'Microsoft Azure', 'Git & GitHub', 'GitLab CI/CD', 'Docker',
      'Postman', 'Visual Studio & VS Code', 'ServiceNow',
      'Azure DevOps Pipelines', 'SSMS'
    ]
  };
  ...
  const experiences = [
    {
      ...
      skills: ["C#", "React", "AsyncAPI", "Azure", "Unit Testing", "UI/UX", "NuGet"]
    },
    {
      ...
      skills: ["Azure", "ASP.NET", "C#", "Web Apps", "Automation", "Root Cause Analysis"]
    },
    {
      ...
      skills: ["ASP.NET", "Angular", "REST API", "Team Management", "CRUD"]
    },
    {
      title: 'Software Engineer Intern',
      company: 'Daily Ninja',
      ...
      skills: ["Python", "Excel", "Data Pipeline", "Automation", "Data Cleansing"]
    }
  ];
      ...
      {loading && (
        <div className="loading-screen">
          <div className="loading-content">
            {/* Pixelated Girl Character */}
            <div className="loading-gif-container">
  <img src={pixelGirlGif} alt="Loading..." className="loading-gif" />
</div>
            ...
            <div className="loading-text">
              <div className="typewriter-container">
                ...
                <span className="typewriter-cursor-loading">|</span>
              </div>
            </div>
          </div>
        </div>
            ...
            <div className="max-w-5xl mx-auto w-full">
              ...
              <div className="flex flex-col gap-6">
                {experiences.map((exp, idx) => (
                  <div key={idx} className="experience-card-wrapper">
                    <button
                      onClick={() =>
